    ...
    <section class="group">
        ...
        <ul style="--gap: 1.5rem;" class="!flex items-start flex-wrap w-full px-20 gap-[var(--gap)]">
            ...
            <li class="fragment w-full lg:w-[calc(50%_-_var(--gap))] lg:list-none bg-purple-900 px-4 rounded-lg">
                <p class="lg:text-base">Kollaboration, Selbstorganisation, Revision u. Feedback</p>
            </li>
            <li class="fragment w-full lg:w-[calc(50%_-_var(--gap))] lg:list-none">
                <p class="lg:text-base">Findet idR Anwendung in der Softwareentwicklung</p>
            </li>
            <li class="fragment w-full lg:w-[calc(50%_-_var(--gap))] lg:list-none">
                <p class="lg:text-base">Projektphasen statt eines Projektplans</p>
            </li>
        </ul>
    </section>
</template>