<template>
    <section>
        <svg class="w-1/2 mx-auto" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 2000 2000" x="0" y="0" shape-rendering="crispEdges">
            <defs></defs>
            <rect x="100" y="100" width="1800" height="1800" fill="#ffffff"></rect>
            ...
            <rect x="1655" y="1769" width="57" height="57" fill="#000000"></rect><svg version="1.1" id="Ebene_1" x="173"
                y="173" width="399" height="399" viewBox="0 0 699.988 699.986"
