<template>
    <svg class="w-6 aspect-square" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100"
        preserveAspectRatio="xMidYMid" style="shape-rendering: auto; display: block;">
        <g>
            <g transform="rotate(0 50 50)">
                <rect fill="#ffffff" height="12" width="6" ry="2.4" rx="2.4" y="24" x="47">
